...
function FeaturesSection() {
  ...
  const features = [
    {
      title: "Portfolio & PnL Tracking",
      blurb:
        "Track realised and unrealised PnL across all positions, with full balance history and trade-level breakdowns.",
      meta: "Portfolio",
    },
    {
      title: "Trader Leaderboards",
      blurb:
        "Rank traders by real performance metrics and see how your strategy compares against others on the platform.",
      meta: "Competition",
    },
    {
      title: "Trending & New Tokens",
      blurb:
        "Discover trending Solana tokens and newly launched projects using live on-chain and market activity.",
      meta: "Discovery",
    },
    {
      title: "Pump.fun Token Tracking",
      blurb:
        "Monitor Pump.fun tokens before and after migration to understand early-stage volatility and behavior.",
      meta: "Early Stage",
    },
    {
      title: "Token Rug Risk Analysis",
      blurb:
        "Analyze token contracts and behavior to surface rug risk scores, red flags, and safety indicators before trading.",
      meta: "Risk",
    },
    {
      title: "Full Token Analytics",
      blurb:
        "Analyze price charts, liquidity, volume, holders, and market signals from a single token page.",
      meta: "Analytics",
    },
  ];
  ...
  return (
    <div className="w-full relative">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(125% 125% at 50% 125%, #000000 40%, #ff722960 80%,#000000 100%)",
        }}
      />
      ...
      <section className="relative mx-auto max-w-6xl px-6 py-20 text-white">
        ...
        <header className="relative mb-6 flex items-end justify-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-black tracking-tight">A Complete Solana Paper Trading Platform</h2>
            {/* <p className="mt-2 text-sm md:text-base text-white/70">
              Everything you need to practice real trading decisions using live Solana market data.
            </p> */}
          </div>
        </header>

        <div className="relative grid grid-cols-1 gap-3 md:grid-cols-6 auto-rows-[minmax(120px,auto)] max-rows-2">
          {features.map((f, i) => (
